      ...
      pipelineObjects: [
        ...
        // },
        {
          ...
          fields: [
            ...
            {
              key:'step',
              stringValue: `s3://dynamodb-emr-${myDDBRegion}/emr-ddb-storage-handler/2.1.0/emr-ddb-2.1.0.jar,org.apache.hadoop.dynamodb.tools.DynamoDbExport,${tableName},${throughputRatio}`,
            },
            {
              key: 'input',
